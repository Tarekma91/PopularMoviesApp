...
public class MovieDateUtils implements MoviesConstantsUtils {
...
//        if (millisSinceEpoch % DAY_IN_MILLIS == ZERO) {
//            isDateNormalized = TRUE_VALUE;
//        }
//
...
//            if (daysFromEpochToProvidedDate - daysFromEpochToToday < TWO) {
//                /*
